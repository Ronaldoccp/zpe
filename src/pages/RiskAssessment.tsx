...
const RiskAssessment: React.FC = () => {
  ...
  const getRiskIcon = (score: number) => {
    if (score >= 70) return <ExclamationTriangleIcon className="h-5 w-5 text-red-600" />;
    if (score >= 40) return <ShieldExclamationIcon className="h-5 w-5 text-yellow-600" />;
    return <CheckCircleIcon className="h-5 w-5 text-green-600" />;
  };

  return (
    <div>
      <h1 className="text-2xl font-semibold text-gray-900">Sistema de Avaliação de Risco</h1>
              ...
              <table className="min-w-full divide-y divide-gray-300">
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {shipments.map((shipment) => (
                    <tr 
                      key={shipment.id} 
                      className={selectedShipment === shipment.id ? 'bg-primary-50' : undefined}
        ...
        <div className="mt-8 bg-white shadow overflow-hidden sm:rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-4 py-5 sm:px-6">
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <h4 className="text-base font-medium text-gray-900 mb-4">Visualização de Fatores de Risco</h4>
              <div className="h-64">
            ...
            {/* Fatores de risco */}
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <h4 className="text-base font-medium text-gray-900 mb-4">Fatores de Risco Analisados</h4>
              <div className="space-y-4">
                {riskFactors.map((factor) => (
                  <div key={factor.id} className="border-b border-gray-200 pb-2">
          ...
          <div className="px-4 py-5 sm:px-6">
            <h4 className="text-base font-medium text-gray-900 mb-2">Recomendações</h4>
